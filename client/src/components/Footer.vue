<template>
  <footer class="bg-[#D9D9D9]">
    <div
      class="flex flex-col items-center justify-between py-12 mx-auto space-y-4 sm:space-y-0 sm:flex-row px-30"
    >
      <div class="flex -mx-2" id="link-icons">
        <a
          href="https://www.facebook.com/HelloGIT"
          class="mx-4"
          aria-label="facebook"
        >
        ...
        <a
          href="https://discord.gg/jzp3j9R3KA"
          class="mx-4"
          aria-label="discord"
        >
